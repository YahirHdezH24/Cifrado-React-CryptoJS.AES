...
class App extends Component {
  ...
  handleInputChange = (event) => { // maneja los cambios en los campos de entrada
  ...
  handleCifradoCesar = () => {
    ...
    if (opcion === "1") {
      ...
      console.log({ decryptedString}); //Decifrar
  ...
  render() { //se encarga de renderizar la interfaz de usuario.

    const { opcion, mensaje, resultado } = this.state;

    return (
      <div className="App">
        <h1 className="mb-4 text-3xl font-extrabold  bg-gradient-to-r to-emerald-600 from-sky-400 text-transparent bg-clip-text dark:text-white md:text-5xl lg:text-6xl">Cifrado César</h1>
